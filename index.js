...
/**
 * Returns the first visible characters of the input string, with the invisible parts preserved.
 * @param {string} input
 * @param {number} length
 * @returns {string}
 */
...
/**
 * Returns `true` if there are no visible characters in the input string, otherwise `false`.
 * @param {string} input
 * @returns {boolean}
 */
...
/**
 * Returns a list of matches that contain an invisible part of the input string, followed by a visible one.
 * @param {string} input
 * @returns {string[][]}
 */
...
/**
 * Returns the visible length of the input string.
 * @param {string} input
 * @returns {number}
 */
